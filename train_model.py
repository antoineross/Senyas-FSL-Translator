...
print("Functions for mediapipe detection and styled landmarks defined.")

# 3. Extracting Keypoints Values into a numpy array
...
# 4. Setting up variables for Data Collection
